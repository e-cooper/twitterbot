...
This bot grabs a tweet from the Twitter stream, a topic from Google News, and creates a quote from the mashup of the two. It attempts to tweet once every half hour.
...
Make an empty project directory somewhere convenient for you, download the ZIP file for this repository, and unzip the contents to your project directory. Go to your project directory in the command line. There should be four files there: `.gitignore`, `README.md`, `bot.js`, and `config.js`. In that directory type:
...
Unless you get something about an error, you should see the results of the bot working. Check the Twitter account for your bot, and it should have generated an interesting quote for you.
